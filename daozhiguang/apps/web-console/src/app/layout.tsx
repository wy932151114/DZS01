...
const NAV_ITEMS = [
  { href: '/dashboard', label: 'Dashboard', icon: LayoutDashboard, color: '#f59e0b' },
  { href: '/bazi', label: '八字排盘', icon: Cpu, color: '#2ECC71' },
  { href: '/wuxing', label: '五行能量', icon: Wind, color: '#E74C3C' },
  { href: '/jiugong', label: '九宫飞星', icon: Grid3X3, color: '#3498DB' },
  { href: '/ai-debug', label: 'AI调试', icon: Brain, color: '#9B59B6' },
  { href: '/cv-scan', label: 'CV扫描', icon: Scan, color: '#1ABC9C' },
];
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="zh-CN">
      <body className="bg-[#0a0e17] text-[#e2e8f0] overflow-x-hidden" style={{ fontFamily: "'Noto Sans SC', system-ui, sans-serif" }}>
